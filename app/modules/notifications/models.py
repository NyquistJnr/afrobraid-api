...
class NotificationType(str, enum.Enum):
    ...
    PAYMENT_DEPOSIT_SUCCEEDED = "PAYMENT_DEPOSIT_SUCCEEDED"
    PAYMENT_FULL_SUCCEEDED = "PAYMENT_FULL_SUCCEEDED"
    PAYMENT_BALANCE_SUCCEEDED = "PAYMENT_BALANCE_SUCCEEDED"
    PROFILE_UPDATED = "PROFILE_UPDATED"
    PASSWORD_CHANGED = "PASSWORD_CHANGED"
    NEW_LOGIN = "NEW_LOGIN"
    BOOKING_RESCHEDULED = "BOOKING_RESCHEDULED"
    PAYMENT_BALANCE_FAILED = "PAYMENT_BALANCE_FAILED"
    BOOKING_CANCELLED_NO_PAYMENT = "BOOKING_CANCELLED_NO_PAYMENT"
    BOOKING_CANCELLED_BY_CUSTOMER = "BOOKING_CANCELLED_BY_CUSTOMER"
    BOOKING_CANCELLED_BY_BRAIDER = "BOOKING_CANCELLED_BY_BRAIDER"
